...
test("Test Fen", () => {
  ...
  expect(PieceArray[array[0][0] - 1].GetName()).toBe("車");
  expect(PieceArray[array[0][1] - 1].GetName()).toBe("馬");
  expect(PieceArray[array[0][2] - 1].GetName()).toBe("象");
  expect(PieceArray[array[0][3] - 1].GetName()).toBe("士");
  expect(PieceArray[array[0][4] - 1].GetName()).toBe("將");
  expect(PieceArray[array[0][5] - 1].GetName()).toBe("士");
  expect(PieceArray[array[0][6] - 1].GetName()).toBe("象");
  expect(PieceArray[array[0][7] - 1].GetName()).toBe("馬");
  expect(PieceArray[array[0][8] - 1].GetName()).toBe("車");
  ...
  expect(PieceArray[array[9][0] - 1].GetName()).toBe("車");
  expect(PieceArray[array[9][1] - 1].GetName()).toBe("馬");
  expect(PieceArray[array[9][2] - 1].GetName()).toBe("相");
  expect(PieceArray[array[9][3] - 1].GetName()).toBe("仕");
  expect(PieceArray[array[9][4] - 1].GetName()).toBe("帥");
  expect(PieceArray[array[9][5] - 1].GetName()).toBe("仕");
  expect(PieceArray[array[9][6] - 1].GetName()).toBe("相");
  expect(PieceArray[array[9][7] - 1].GetName()).toBe("馬");
  expect(PieceArray[array[9][8] - 1].GetName()).toBe("車");
});
...
test("Test UpdateFen", () => {
  ...
  expect(PieceArray[array[8][4] - 1].GetName()).toBe("帥");
